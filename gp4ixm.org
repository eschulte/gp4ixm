...
** throttle back alarms
generally 100 times/sec seems to be enough time
- [[file:single-evolve/sketch.pde::Alarms%20Mutation%20and%20Breeding%20eventually%20Sharing%20and%20Data%20collection][alarms]]

** crossover
tried *many* different versions of crossover
- [[file:single-evolve/sketch.pde::individual%20crossover%20individual%20mother%20individual%20father][crossover]]

** adjustable GP parameters
now possible to change GP parameters w/o re-burning the sketch
...
solutions
- pass by reference (throughout the code)
- [[file:single-evolve/sketch.pde::bool%20check][check]] individuals to isolate problem areas (still occasional weirdness)
- [[file:single-evolve/sketch.pde::if%20mutation_tick%200%20don%20t%20reschedule%20if%20tick%20is%200][safer-alarm-scheduling]]
