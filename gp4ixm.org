...
#+begin_src ruby :results raw output :exports code :noweb
  ...
  puts "|sharing|mutation|breeding|tournament|goal|runtime|average|"
  puts "|--------"
  runtime = 0; average = 0
  results.each do |r|
...
| sharing | mutation | breeding | tournament | goal |          runtime | average |
|---------+----------+----------+------------+------+------------------+---------|
|       0 |       10 |        0 |          0 |   14 | 930.752777777778 |         |
|       0 |       10 |       10 |          0 |   12 |         838.1225 |         |
...
| sharing | mutation | breeding | tournament | goal |          runtime | average |
|---------+----------+----------+------------+------+------------------+---------|
|     100 |       10 |       10 |          0 |   19 | 1404.53896135266 |         |
|       0 |       10 |       10 |          0 |   15 | 944.637903225806 |         |
